...
#include "_coder_eegcfilt_mex.h"

/* Variable Definitions */
emlrtCTX emlrtRootTLSGlobal = NULL;
emlrtContext emlrtContextGlobal = { true, false, 131434U, NULL, "eegcfilt", NULL,
...
static void c_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src, const
  emlrtMsgIdentifier *msgId, emxArray_real_T *ret)
{
  static const int32_T dims[1] = { 4996 };
 ...
 * Return Type  : void
 */
void eegcfilt_api(const mxArray *prhs[1], const mxArray *plhs[1])
{
  emxArray_real_T *X;
  emxArray_real_T *Y;
...
/*
 * File trailer for _coder_eegcfilt_api.c
 *
 * [EOF]
 */
