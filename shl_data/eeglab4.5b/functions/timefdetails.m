...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Global Description: timef() performs normalized time/frequency averaging 
% using FFT-, wavelet-, or multitaper DFT estimates. The wavelets are N-cycle 
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ERSP (S. Makeig, Electroencephalogr Clin Neurophysiol 86:283-93, 1993) 
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ITC: (Inter-trial Coherence, cf. Tallon-Baudry et al., "Phase-locking factor")
...
%                  as the phase coupling factor           {default: 'phasecoher'}.
%
% Optional Detrending:
%   'detret'    = ['on'|'off'], Detrend data in time.       {default: 'off'}
%   'detrep'    = ['on'|'off'], Detrend data across trials. At each time point,
%                 compute the meand and linear trend across the set of ordered trials 
%                 and remove it. This also subtracts the ERP from each trial) {'off'}
%
...
%
%  'timesout'  = Number of output times (int<frames-winframes) {default: 200}
...
%
%      powbase  = The baseline power spectrum removed to compute the ERSP
