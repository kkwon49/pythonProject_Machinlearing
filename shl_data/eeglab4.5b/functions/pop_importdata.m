...
if nargin < 1                 % if several arguments, assign values 
   ...
   % -----------------------
    geometry    = { [2 0.1 0.8 0.5] [1.4 0.7 .8 0.5] [2 0.1 0.8 0.5] [2 0.1 0.8 0.5] [2 0.1 0.8 0.5] ...
                    [2 0.1 0.8 0.5] [1.5 0.6 0.8 0.5] [1] [2 0.1 0.8 0.5] [2 0.1 0.8 0.5] };
    ...
    uilist = { ...
         ...
         ...
         { 'Style', 'text', 'string', '      (note: use menu "Edit > Channel locations" to import specific file formats)', 'horizontalalignment', 'right' }, ...
         ...
