...
% This program requires Matlab Version >= 5.2
%
...
%
% Version 3.03Alpha, 03/17/00
% (c) Herbert Ramoser (ramoser@dpmi.tu-graz.ac.at)
%
...
fig=figure( ...
    ...
    'Tag', 'ViewEDFFigure', ...
    'Name', 'EDF File Viewer - (C) 1998-2000 DPMI, Graz University of Technology');
...
if exist('sedfchk','file')
        EDFHead=sedfchk(EDFHead);
end;
