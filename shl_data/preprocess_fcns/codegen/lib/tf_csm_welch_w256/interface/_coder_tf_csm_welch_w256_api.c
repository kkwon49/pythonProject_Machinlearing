 ...
 * File: _coder_tf_csm_welch_w256_api.c
 *
...
#include "_coder_tf_csm_welch_w256_mex.h"
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "tf_csm_welch_w256",                 /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
...
{
  real_T (*ret)[512];
  static const int32_T dims[2] = { 256, 2 };
 ...
 * Return Type  : void
 */
void tf_csm_welch_w256_api(const mxArray *prhs[1], const mxArray *plhs[1])
{
  real32_T (*Y)[192];
  real_T (*X)[512];
 ...
 * Return Type  : void
 */
void tf_csm_welch_w256_atexit(void)
{
  mexFunctionCreateRootTLS();
  emlrtEnterRtStackR2012b(emlrtRootTLSGlobal);
  emlrtLeaveRtStackR2012b(emlrtRootTLSGlobal);
  emlrtDestroyRootTLS(&emlrtRootTLSGlobal);
  tf_csm_welch_w256_xil_terminate();
}
 ...
 * Return Type  : void
 */
void tf_csm_welch_w256_initialize(void)
{
  mexFunctionCreateRootTLS();
 ...
 * Return Type  : void
 */
void tf_csm_welch_w256_terminate(void)
{
  emlrtLeaveRtStackR2012b(emlrtRootTLSGlobal);
  emlrtDestroyRootTLS(&emlrtRootTLSGlobal);
}
...
/*
 * File trailer for _coder_tf_csm_welch_w256_api.c
 *
 * [EOF]
 */
