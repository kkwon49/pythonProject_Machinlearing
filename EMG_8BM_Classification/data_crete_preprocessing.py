...
def csv_file_spilt():
    # 최상단 위치
    main_root = '/Users/kang-kyukwon/PycharmProjects/pythonProjectEMG/EMG_8BM_Classification/'
    # 하위 위치
    file = f'Data/Reaching/Segmented/'
    os.chdir(file)
...
def image_visualization():
    ...
    for i in root:
        ...
        for j in root_data:
            ...
            # 데이터셋마다 y값을 바꿔야하는 상황
            plt.ylim([-0.5 * 10 ** -5, 1.3 * 10 ** -5])  # Y축의 범위: [ymin, ymax]
